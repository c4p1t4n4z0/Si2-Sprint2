...
<x-mi_container>
<div class="bg-white rounded-lg p-5 shadow-lg mr-20">

    <p class="text-2xl text-gray-700 font-semibold pl-10 "> Lista de documentos para el credito {{ $credito->nombre }} </p>

<div class="mt-5">
    @foreach ($requisitos  as $r )

    <div class="flex borber-b bg-gray-100 rounded mb-2 border-gray-700 justify-between  space-y-3">
        <p class=" w-1/2 "> {{ $r->nombre }}</p>
        <input type="file">
    </div>
@endforeach
</div>
