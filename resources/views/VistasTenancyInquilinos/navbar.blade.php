...
@endphp
    ...
    <div class="bg-gray-100   h-screen flex p-2 pt-3 ">
        ...
        <div class="bg-gray-100  text-gray-600  px-2 w-64  h-full rounded-xl mr-6 ">
            <!--transition-transform duration-300 ease-in-out-->
            {{-- logo y botno para abriir las ventanas  --}}
            <div class="flex items-center ">

                <div  class="text-center flex flex-row-reverse justify-center py-5 border-gray-400 border-b mb-4  w-full ">
...
{{-- //{{ route('empleados.index') }} --}}
            <div class=" flex flex-col space-y-2  ">
                ...
                @php
                    ...
                    ? 'flex items-center text-sm font-medium   py-2 px-2 bg-gray-300 text-gray-600 hover:text-base rounded-md transition duration-150 ease-in-out'
                    : 'flex items-center text-sm font-medium   py-2 px-2 hover:bg-white text-gray-600 hover:text-base rounded-md transition duration-150 ease-in-out';
                @endphp
