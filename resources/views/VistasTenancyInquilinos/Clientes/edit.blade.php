...
@section('Contenido')
    ...
    <div class="overflow-x-auto  p-5 ">
        <div class="flex  p-5 border-b mb-8">
            ...
            <p class="text-xl mt-1.5 font-bold text-slate-800"> Actualizar Cliente</p>
        </div>

        <div class=" flex justify-center items-center">
            <div class=" w-full ">
                {{-- <p> hola que tal</p> {{ route('clientes.uptade',$cliente->id_usuario) }}--}}
                        ...
                        <div class="grid grid-row-12 grid-cols-3
                            ...
                            <div class="flex flex-col ">
                                ...
                                <input
                                    ...
                                    value="{{ old('paterno',$cliente->ap_paterno) }}" />
                            </div>
                            ...
                            <div class="flex flex-col ">
                                ...
                                <input
                                    ...
                                    value="{{ old('materno',$cliente->ap_materno) }}" />
                            </div>
                            ...
                            ">
                             ...
                             <div class="mt-4 flex flex-col items-center ">
                                 <img id="img_fotoventas" src="{{ asset('img/Clientes/' . old('foto', $cliente->foto)) }}"
                            ...
                            <div class="flex flex-col row-start-5 ">
                                ...
                                <input
                                    ...
                                    value="{{ old('correo',$cliente->email) }}" />
                            </div>
                            ...
                            <div class="flex flex-col row-start-5 ">
                                ...
                                <input
                                    ...
                                    value="{{ old('contrasena',$cliente->password) }}" />
                            </div>
