...
@section('Contenido')
    ...
    <div class="overflow-x-auto  p-5 ">
        <div class="flex  p-5 border-b mb-8">
            ...
            <p class="text-xl mt-1.5 font-bold text-slate-800"> Show de Area</p>
        </div>
                        ...
                        <div class="grid grid-row-12 grid-cols-1
                            ...
                            <div class="flex flex-col ">
                                ...
                                <input
                                    ...
                                    id="nombre" name="nombre" type="text" autocomplete="off" disabled
                            ...
                            <div class="flex flex-col row-start-2 row-span-4 ">
                                ...
                                {{-- <input
                                    ...
                                    border-gray-300 rounded border
                                    focus:outline-none focus:border focus:border-blue-900 capitalize" disabled
