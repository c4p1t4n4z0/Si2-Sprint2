                ...
                <div class="row gx-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="card mb-5 mb-xl-0">
                                <div class="card bg-gradient-light shadow-lg">
                                    <span class="badge rounded-pill w-30 mt-n2 mx-auto" style="background-color: #0AD149">nombre</span>
                                    <div class="card-header text-center pt-4 pb-3 bg-transparent">
                                        <h1 class="font-weight-bold mt-2 text-dark"
                                            style="font-family: Arial, Helvetica, sans-serif">
                                            <small class="text-lg mb-auto">$</small>detalle precio<small
                                                class="text-lg">/mo</small>
                                        </h1>
                                    </div>
                                    <div class="card-body text-lg-start text-center pt-0">
                                        ...
                                        <div class="p-2 text-center">
                                            <span class="text-dark"><b class="text-center">tipo plan</b></span>
                                        </div>

                                        <div class="d-flex justify-content-lg-start justify-content-center p-2">
                                            <i class="material-icons my-auto text-dark">done</i>
                                            <span class="ps-3 text-dark">miembors  team members</span>
                                        </div>

                                        <div class="d-flex justify-content-lg-start justify-content-center p-2">
                                            <i class="material-icons my-auto text-dark">done</i>
                                            <span class="ps-3 text-dark">storage GB Cloud storage </span>
                                        </div>
